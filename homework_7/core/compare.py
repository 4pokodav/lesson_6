...
def make_res_table(results: List[Dict], test_fn_names: Dict[str, str], input_shape: Tuple[int, int, int]):
    headers = [
        'function',
        'dataloader_type',
        'precision',
    ...
    print(table)
    with open(f'results_{input_shape[1]}x{input_shape[2]}.md', 'w') as f:
...
def benchmark_models(
    ...
    real_dataset = CustomImageDataset(root_dir='/mnt/c/Users/uservb/Desktop/practice/homework_5/data/test', target_size=(input_size, input_size))
    ...
    make_res_table(results, test_fn_names, input_shape)

if __name__ == '__main__':
    for input_size in [256]:
        print(f'\nBenchmarking for input size: {input_size}')
        benchmark_models(
            model_path=f'/mnt/c/Users/uservb/Desktop/practice/homework_7/weights/best_resnet18_{input_size}.pth',
            num_runs=50,
            min_batch_size=32,
            max_batch_size=64,
            opt_batch_size=64,
